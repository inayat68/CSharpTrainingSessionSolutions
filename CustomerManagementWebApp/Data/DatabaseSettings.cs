...
public class DatabaseSettings
{
    ...
    public DatabaseSettings(IConfiguration configuration, IWebHostEnvironment environment, IServiceProvider sp, string[] args)
    {
        ...
        //dotnet run -- CompanyName=MyCompany Environment=Development Port=5001
        if (args.Length == 0)
        {
